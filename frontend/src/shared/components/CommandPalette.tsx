...
const ALL_COMMANDS: PageCommand[] = [
  ...
  { label: "Investigations", path: "/investigations", iconName: "Search" },
  { label: "Campaigns", path: "/campaigns", iconName: "Flag" },
  { label: "Diff & Merge", path: "/investigation-diff", iconName: "GitBranch" },
  { label: "AI Hub", path: "/hub", iconName: "Sparkles" },
  { label: "Scanners", path: "/scanners", iconName: "Radar" },
  { label: "Playbooks", path: "/playbooks", iconName: "BookOpen" },
  { label: "Watchlist", path: "/watchlist", iconName: "Bell" },
  { label: "Threat Actors", path: "/threat-actors", iconName: "Shield" },
  { label: "Image Checker", path: "/image-checker", iconName: "ScanSearch" },
  { label: "Doc Metadata", path: "/doc-metadata", iconName: "FileText" },
  { label: "Email Headers", path: "/email-headers", iconName: "Mail" },
  { label: "MAC Lookup", path: "/mac-lookup", iconName: "Cpu" },
  { label: "Domain Permutation", path: "/domain-permutation", iconName: "Globe" },
  { label: "Cloud Exposure", path: "/cloud-exposure", iconName: "Cloud" },
  { label: "WiGLE", path: "/wigle", iconName: "Wifi" },
  { label: "Stealer Logs", path: "/stealer-logs", iconName: "AlertTriangle" },
  { label: "Supply Chain", path: "/supply-chain", iconName: "Package" },
  { label: "Credential Intel", path: "/credential-intel", iconName: "KeyRound" },
  { label: "Fediverse", path: "/fediverse", iconName: "Users" },
  { label: "SOCMINT", path: "/socmint", iconName: "UserSearch" },
  { label: "Tech Recon", path: "/tech-recon", iconName: "Network" },
  { label: "IMINT / GEOINT", path: "/imint", iconName: "MapPin" },
  { label: "Pentest Dashboard", path: "/pentest/dashboard", iconName: "BarChart3" },
  { label: "Findings", path: "/pentest/findings", iconName: "ShieldAlert" },
  { label: "Compliance", path: "/pentest/compliance", iconName: "ClipboardCheck" },
  { label: "Report Builder", path: "/report-builder", iconName: "FileOutput" },
  { label: "GDPR Requests", path: "/gdpr", iconName: "Scale" },
  { label: "Maltego", path: "/maltego", iconName: "Plug" },
  { label: "Settings", path: "/settings", iconName: "Settings" },
  { label: "Admin", path: "/admin", iconName: "ShieldCheck" },
];
