"""SQLAlchemy ORM model for GitHub Intel scan results."""
import uuid
...
class GitHubIntelModel(Base):
    __tablename__ = "github_intel_scans"
    ...
    def __repr__(self) -> str:
        return f"<GitHubIntelModel id={self.id} query={self.query!r}>"
