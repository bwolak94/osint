"""SQLAlchemy ORM model for Instagram Intel scan results."""
import uuid
...
class InstagramIntelModel(Base):
    __tablename__ = "instagram_intel_scans"
    ...
    def __repr__(self) -> str:
        return f"<InstagramIntelModel id={self.id} query={self.query!r}>"
